...
/// retrieved.
public enum AuthorizedCertificateView: Codable, Equatable, Sendable {
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    switch self {
    case .basicCertificate: return try container.encode(0)
    case .fullCertificate: return try container.encode(1)
