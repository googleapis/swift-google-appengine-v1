  ...
  class FirewallTransport: FirewallStub {
    ...
    public func listIngressRules(
      ...
      return try GoogleCloudWkt._ProtoJSONDecoder().decode(
        GoogleAppengineV1.ListIngressRulesResponse.self, from: data)
    }
    ...
    public func batchUpdateIngressRules(
      ...
      let (data, _) = try await self.inner.rpc(for: req).get()
      return try GoogleCloudWkt._ProtoJSONDecoder().decode(
        GoogleAppengineV1.BatchUpdateIngressRulesResponse.self, from: data)
    }
    ...
    public func createIngressRule(
      ...
      let (data, _) = try await self.inner.rpc(for: req).get()
      return try GoogleCloudWkt._ProtoJSONDecoder().decode(
        GoogleAppengineV1.FirewallRule.self, from: data)
    }
