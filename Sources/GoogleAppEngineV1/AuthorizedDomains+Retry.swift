...
extension Clients {
  final class AuthorizedDomainsRetry: AuthorizedDomainsStub {
    let inner: any AuthorizedDomainsStub
    let options: GoogleCloudGax.ClientOptions

    public init(_ inner: any AuthorizedDomainsStub, options: GoogleCloudGax.ClientOptions) {
      self.inner = inner
    ...
    public func listAuthorizedDomains(
      ...
      try await self._intercept(
        ...
        idempotent: true,
        action: {
          (r: ListAuthorizedDomainsRequest, o: GoogleCloudGax.RequestOptions) async throws
            -> GoogleAppEngineV1.ListAuthorizedDomainsResponse
          in
          return try await self.inner.listAuthorizedDomains(request: r, options: o)
        })
    }
