...
extension Clients {
  protocol AuthorizedDomainsStub {
  ...
  class AuthorizedDomainsTransport: AuthorizedDomainsStub {
    ...
    public func listAuthorizedDomains(
      ...
      let path = try { () throws -> Swift.String in
        ...
        return "/v1/\(pathVariable0)/authorizedDomains"
      }()
      var query = [
      ...
      return try GoogleCloudWkt._ProtoJSONDecoder().decode(
        GoogleAppEngineV1.ListAuthorizedDomainsResponse.self, from: data)
    }
