...
extension Clients {
  ...
  class DomainMappingsTransport: DomainMappingsStub {
    ...
    public func listDomainMappings(
      ...
      let path = try { () throws -> Swift.String in
        ...
        return "/v1/\(pathVariable0)/domainMappings"
      }()
      var query = [
      ...
      return try GoogleCloudWkt._ProtoJSONDecoder().decode(
        GoogleAppEngineV1.ListDomainMappingsResponse.self, from: data)
    }
    ...
    public func getDomainMapping(
      ...
      let (data, _) = try await self.inner.rpc(for: req).get()
      return try GoogleCloudWkt._ProtoJSONDecoder().decode(
        GoogleAppEngineV1.DomainMapping.self, from: data)
    }
