  ...
  class ServicesTransport: ServicesStub {
    ...
    public func listServices(
      ...
      return try GoogleCloudWkt._ProtoJSONDecoder().decode(
        GoogleAppEngineV1.ListServicesResponse.self, from: data)
    }
    ...
    public func getService(
      ...
      let (data, _) = try await self.inner.rpc(for: req).get()
      return try GoogleCloudWkt._ProtoJSONDecoder().decode(
        GoogleAppEngineV1.Service.self, from: data)
    }
    ...
    public func updateService(
      ...
      query.append(contentsOf: try encoder.encode(request.migrateTraffic, prefix: "migrateTraffic"))
      var req = try await self.inner.Request(path: path, query: query)
